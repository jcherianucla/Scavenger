...
class JSSAlertView: UIViewController {
    ...
    var titleFont = "GothamHTF-Light"
    var textFont = "GothamHTF-Light"
    var buttonFont = "GothamHTF-Book"
    ...
    override func viewDidLayoutSubviews() {
        ...
        let titleSize = CGSize(width: contentWidth, height: 48)
    ...
    func success(viewController: UIViewController, title: String, text: String?=nil, buttonText: String?=nil, cancelButtonText: String?=nil) -> JSSAlertViewResponder {
        return self.show(viewController, title: title, text: text, buttonText: buttonText, cancelButtonText: cancelButtonText, color: nil)
    }
    ...
    func show(viewController: UIViewController, title: String, text: String?=nil, buttonText: String?=nil, cancelButtonText: String?=nil, color: UIColor?=nil, iconImage: UIImage?=nil) -> JSSAlertViewResponder {
        ...
        titleLabel.font = UIFont(name: self.titleFont, size: 20)
        ...
        let buttonColor = UIImage.withColor(adjustBrightness(MemCapColors.MemCapOrange(), amount: 1.0))

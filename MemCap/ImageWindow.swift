...
//  MemCap
//
//  Created by Jahan Cherian on 5/30/16.
...
class ImageWindow: UIView
{
    ...
    func setAutoResize()
    {
        ...
        userImage.autoresizingMask = [.FlexibleWidth, .FlexibleHeight]
    }
    ...
    func loadViewFromNib() -> UIView {
        ...
        let nib = UINib(nibName: "ImageWindow", bundle: bundle)
